...
urlpatterns = [
    ...
    path('applications/board/', views.application_board_redirect, name='jobs.application_board_redirect'),
    path('<int:id>/applications/board/', views.application_board, name='jobs.application_board'),
